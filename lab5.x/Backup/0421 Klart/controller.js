...
function getJSON(sensorNum) 
    {

    if (sensorNum == 1){sensor.key="J3Wgj9qegGFX4r9KlxxGfaeMXQB";}
    else if (sensorNum == 2){sensor.key="lB6p49pzXdFGQjpLwzzOTWj10rd";}
    else if (sensorNum == 3){sensor.key="BkPNOapq2WSMgpVlNQQKFYXPBWr";}
...
function printData()   
    {
        ...
        if (sensor && sensor.data) 
            {
            // Display the info.
                html = '<h1 id="myh1">Sensor Data</h1>'
