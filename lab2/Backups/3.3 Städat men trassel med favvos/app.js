...
function loadFavorites(){
	...
	// var divvar = document.getElementsByClassName('favoDiv');
	// var j = 0;
	// console.log('divvars läng: ' + divvar.length);
	
	// for (var i = 0; i < divvar.length; i++) {
	//     divvar[i].addEventListener("click", function(){
	//     	console.log('i= ' + i);
	//     	console.log(app.favorites[j])
	//     	app.gotoPage(app.favorites[j])
	//     	j += 1;
